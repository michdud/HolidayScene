...
class App{
  ...
  update() {
    ...
    if (pendingResourceNames.length === 0) {
      ...
      this.overlay.innerHTML = "<div style=\"border-style:solid; border-color:white; color:white; padding:1rem; background-color:rgba(179, 179, 179, 0.5);\">Use WASD to move, mouse to point.</div>";
    } else {
